...
public class ReservationController {
    ...
    public static class Dates { // Classe pour récupérer les dates au format String dans le html
        Long id;
        String date_d;
        String hours;
        String minutes;
    ...
    public RedirectView addReservation(@ModelAttribute("datesF") Dates dates, Model m, @RequestParam(value = "listuser", required = false) int[] listuser, Reservation reservation) throws ParseException {
        Timestamp TStart;
        try {
            TStart = ParseTimestamp(dates.getDate_d());
        } catch (Exception E) {
